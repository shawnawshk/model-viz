...
REG.models["glm-5.3-flash"] = {
  ...
  // 点一下旁边的 TP1×DP8 就能看到同一台机器上并发跳 6 倍(128K/util 0.90 下 53 → 320 路;
  ...
  // 滑块脱钩 —— 按钮上标着 320 路(128K/0.90)而页面显示 40 路(1M/0.90)。第三行由 markPreset() 按当前
  ...
  //     1K/0.70   1751  1936  2200  2372  5904  6904   ← TP2×DP4 反超 TP1×DP8
  //     1K/1.00   3279  4288  4384  4724 10592 11384   ← 同上
  //   128K/0.90     53   320   188   364   832   912
  //     1M/1.00      7    48    28    56   128   136
  // TP1×DP8 对 TP8/DP1 的领先幅度从 6.0× 缩到 1.11×;短上下文下 KV 复制的代价变小,
